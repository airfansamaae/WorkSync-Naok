                ...
                <div className="relative">
                  ...
                  {isMonthPickerOpen && (
                    <>
                      ...
                      />
                      <div className="absolute top-full left-1/2 -translate-x-1/2 mt-2 w-72 bg-white rounded-2xl shadow-xl border border-purple-100 p-3 z-40">
                        <div className="flex items-center justify-between pb-2 mb-2 border-b border-slate-100">
                          <span className="text-xs font-bold text-slate-700">เลือกเดือน ({thaiBuddhistYear})</span>
                          <div className="flex items-center gap-1">
                            <button
                              type="button"
                              onClick={() => setCalendarYear((prev) => prev - 1)}
                              title="ปีก่อนหน้า"
                              className="p-1 hover:bg-slate-100 rounded-lg text-slate-600 text-xs font-bold px-2 cursor-pointer"
                            >
                              -1 ปี
                            </button>
                            <button
                        ...
                        <div className="grid grid-cols-3 gap-1.5">
                          {THAI_MONTH_NAMES.map((mName, mIdx) => {
                            ...
                            const isNow = mIdx === now.getMonth() && calendarYear === now.getFullYear();
                            return (
                              <button
                                key={mIdx}
                                type="button"
                                ...
                                className={`px-2 py-2 text-xs rounded-xl font-medium transition-all text-center cursor-pointer ${
                                  isSelected
